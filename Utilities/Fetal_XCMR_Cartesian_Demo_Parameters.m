function [ACQ,PHYSIO] = Fetal_XCMR_Cartesian_Demo_Parameters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ACQ.nMeasurements        = 1;    % [Use reasonable scanner values 500-5000]
...
ACQ.nFrames              = 15;     % [Use reasonable scanner values 1-30] 
